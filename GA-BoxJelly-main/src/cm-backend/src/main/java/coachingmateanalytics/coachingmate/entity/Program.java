...
/**
 * Represents a training program with relevant details.
 */
public class Program {
    ...
    /**
     * Constructs a Program object with the given program ID, title, start date, phase,
     * activity type, level, and number of weeks.
     *
     * @param program_id    The program ID
     * @param title         The program title
     * @param start_date    The program start date
     * @param phase         The program phase
     * @param activity_type The program activity type
     * @param level         The program level
     * @param weeks         The number of weeks in the program
     */
