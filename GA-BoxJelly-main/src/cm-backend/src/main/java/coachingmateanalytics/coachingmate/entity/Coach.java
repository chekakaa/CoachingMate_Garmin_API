...
/**
 * Coach entity class for CoachingMate application.
 */
public class Coach {
     ...
     *
     * @param user_id The unique identifier for the coach.
     * @param user_login The coach's username.
     * @param user_pass The coach's password.
     * @param user_activation_key The coach's activation key.
     * @param user_email The coach's email address.
     * @param user_status The coach's account status.
     * @param display_name The coach's display name.
     * @param created_date The date when the coach's account was created.
     */
