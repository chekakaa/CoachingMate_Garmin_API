...
/**
 * Planner class representing a single planner entity in the CoachingMate application.
 */
public class Planner {
    ...
    /**
     * Constructs a Planner object with the given parameters.
     *
     * @param planner_id the ID of the planner
     * @param title the title of the planner
     * @param starting_date the starting date of the planner
     * @param end_interval the end interval of the planner
     * @param display_countdown the display countdown of the planner
     * @param reverse_countdown the reverse countdown of the planner
     * @param added_by the user who added the planner
     * @param tc_start_date the start date for the training calendar
     * @param tc_interval the interval for the training calendar
     */
